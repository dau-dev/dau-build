...
test:  ## run python tests
	python -m pytest -v dau_build/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v dau_build/tests --cov=dau_build --cov-report term-missing --cov-report xml
